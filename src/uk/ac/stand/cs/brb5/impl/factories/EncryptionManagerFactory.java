...
/**
 * 
 * Factory that returns EncryptionManager objects.
 * 
 * @author Ben
 *
 */
public class EncryptionManagerFactory implements IEncryptionManagerFactory {

	/**
	 * @see uk.ac.stand.cs.brb5.interfaces.IEncryptionManagerFactory#getEncryptionManager()
	 */
