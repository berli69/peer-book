...
import uk.ac.stand.cs.brb5.impl.util.pageContent.Image;
 ...
 *
 */
public class ImageHandler implements IPageHandler {

	/**
	 * Gets the requested filename and returns it as an image.
	 * 
	...
	public Response handleRequest(Request request) throws PeerBookException {
		...
		return new Response(new Image(filename));
	}

	/**
	 * Handles requests for filenames ending in: ".jpg", ".gif", ".jpeg", ".png"
	 * 
	...
	public boolean handlesRequest(String requestType) {
		if (requestType.endsWith(".jpg") || requestType.endsWith(".gif") || requestType.endsWith(".jpeg") || requestType.endsWith(".png")) {
			return true;
		} else {
			return false;
		}
